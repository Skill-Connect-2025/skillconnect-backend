...
urlpatterns = [
    ...
    path('jobs/<int:job_id>/applications/<int:application_id>/respond/', JobApplicationResponseView.as_view(), name='job_application_response'),
    ...
    path('my-applications/', UserApplicationsView.as_view(), name='my_applications'),
